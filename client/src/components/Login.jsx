  ...
  return (
    <div className='bg-black  text-white flex items-center min-h-screen '>
      ...
      <div className="flex flex-col justify-center p-8 md:p-14">
          <h1 class="bg-gradient-to-r from-pink-600 to-fuchsia-900 bg-clip-text text-transparent mb-6 h-12 text-4xl font-semibold">Sign in</h1>
          <form>
          ...
          <div class="text-center text-gray-400">
            ...
            <a href='/auth/register' class="font-bold text-white">Register for free</a>
          </div>
        </div>
      </div>
    </div>
